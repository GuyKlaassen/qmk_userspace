...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_LR(  // Base layer: Magic Sturdy.
    ...
    [SYM] = LAYOUT_LR(  // Symbols layer: Magic Sturdy.
    _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  ,
    _______, _______, KC_7   , KC_8   , KC_9   , _______,
    _______, KC_0   , KC_1   , KC_2   , KC_3   , _______,
    DB_TOGG, _______, KC_4   , KC_5   , KC_6   , _______,
                                                 _______, _______,

                      KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11,
                      _______, C_MAGIC, KC_HASH, KC_DLR , _______, KC_F12,
                      _______, KC_EXLM, KC_AT  , KC_PERC, _______, _______,
                      _______, KC_CIRC, KC_AMPR, KC_ASTR, _______, _______,
             _______, _______
  ),

  [NAV] = LAYOUT_LR(  // Navigation layer: Magic Sturdy.
